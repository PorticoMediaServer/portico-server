...
const images = [
  { id: 'poster-current', type: 'poster', source: 'provider', provider: 'tmdb', remoteUrl: 'https://example.test/current.jpg', width: 1000, height: 1500, sortOrder: 0, preferred: true, createdAt: '2026-07-01T12:00:00Z' },
  { id: 'poster-upload', type: 'poster', source: 'manual', provider: 'upload', remoteUrl: 'https://example.test/upload.jpg', width: 1200, height: 1800, sortOrder: 1, preferred: false, createdAt: '2026-07-02T12:00:00Z' },
  { id: 'poster-alternate', type: 'poster', source: 'provider', provider: 'fanart', remoteUrl: 'https://example.test/alternate.jpg', width: 900, height: 1350, sortOrder: 2, preferred: false, createdAt: '2026-07-03T12:00:00Z' },
];
