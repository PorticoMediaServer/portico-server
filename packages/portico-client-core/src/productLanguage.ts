...
const problemCodeMessages: Readonly<Record<string, ProductMessageId>> = Object.freeze({
  ...
  invite_consumed: "sharing.invitation-consumed",
  invite_expired: "sharing.invitation-expired",
  invite_not_found: "sharing.invitation-not-found",
  invite_revoked: "sharing.invitation-revoked",
  invite_wrong_recipient: "sharing.invitation-wrong-recipient",
